...
# from intera_examples import EERecorder
from ee_recorder import EERecorder
...
Related examples:
  joint_position_file_playback.py; joint_trajectory_file_playback.py.
    ...
    parser.add_argument(
        ...
        help='rate at which to record (default: 20)'
    )
    ...
    recorder = EERecorder(args.filename, args.record_rate)
