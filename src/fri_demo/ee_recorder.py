...
class EERecorder(object):
    def __init__(self, filename, rate, side="right"):
        ...
        if self._gripper:
            ...
            if not self._gripper.is_calopenibrated():
        ...
        if self._filename:
            ...
            with open(self._filename, 'w') as f:
                ...
                while not self.done():
                    ...
                    ee_pose = self._limb_right.endpoint_pose()
                    f.write(f"{ee_pose}")
                    #f.write(f"Position: {ee_pose["position"]}; Orientation: {ee_pose["orientation"]}") 
                    print(ee_pose)
                    # with open
